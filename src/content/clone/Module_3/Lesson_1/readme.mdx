...
<SingleFigure size='large' src="./images/clone/Module_3/image2.jpeg" caption={<span>Image credit: "Astronaut at spacewalk" by Vadimsadovski via <a href="https://stock.adobe.com/contributor/203529807/vadimsadovski?load_type=author&prev_url=detail&asset_id=132366202">AdobeStock</a>, Standard license (external link)</span>} link="https://stock.adobe.com/contributor/203529807/vadimsadovski?load_type=author&prev_url=detail&asset_id=132366202" external={true}/>

### Example

Using vast space-flown animal and human samples as well as astronaut biological data from GeneLab, a recent paper published in _Nature_ found what may be the culprit behind many of the side effects from travel to space: mitochondrial stress. (Clyde, 2021)
...
For additional information about the study of mitochondrial stress in the bodies of astronauts, watch [Living and Working in Space: Twins Study](https://www.youtube.com/watch?v=c9moR-KQpDQ&embeds_referring_euri=https%3A%2F%2Fopenscience101.org%2F&feature=emb_imp_woyt) (external link) on NASA's YouTube channel.
...
<SingleFigure size='small' src="./images/clone/Module_3/image3.jpeg" caption={<span>The Turing Way Community. This illustration is created by Scriberia with The Turing Way community, used under a CC-BY 4.0 license. <a href="https://zenodo.org/records/3332808">DOI: 10.5281/zenodo.3332807</a> (external link)</span>} link="https://zenodo.org/records/3332808" external={true}/>
...
<QuoteImage quote={<span>Open data is data that can be freely used, re-used and redistributed by anyone - subject only, at most, to the requirement to attribute and share alike. (<em>What is Open Data?</em>, n.d.)</span>} byWho={<span><em>What is Open Data?</em>, n.d.</span>} byWhoLink="https://opendatahandbook.org/guide/en/what-is-open-data/" bgImage="./images/clone/Module_3/opendatahandbookquote.jpg" caption={<span>Image Credit: Photo by Killian Cartignies on <a href="https://unsplash.com/photos/person-wearing-silver-bracelet-holding-a-light-oKb2_15Uc8w">Unsplash</a> (external link)</span>} captionLink="https://unsplash.com/photos/person-wearing-silver-bracelet-holding-a-light-oKb2_15Uc8w" captionExternal={true}/>
...
<Definitions>
    ...
    <Definition title='Informing Resource Management'>
      <p><strong>Example: Changes in Fish Composition in the Australian East Coast Recreational Marlin Fishery</strong></p>
      <p>A study in <i>Springer Nature</i> included data from the <a href="https://www.dpi.nsw.gov.au/fishing/recreational/resources/fish-tagging/game-fish-tagging">New South Wales game fish tagging program</a> (external link) to help map changes in fishery catch composition. The findings helped emphasize the need for adaptive and sustainable management strategies for fishing practices at the local and global scale to reduce the effects of current fishing practices and the emergence of new fishing technologies on fish availability. (Guillemin et al., 2025) This example shows how open data can lead to policy change that directly impacts the lives of communities.</p>
    </Definition>
...
<SingleFigure size='medium' src="./images/clone/Module_3/image6.jpeg" caption='Image source: Word cloud "Open Research Data - the FAIRest Data is the Future of Science - Estonia national OpenAIRE event" by OpenAIRE is licensed under CC 4.0'/>
...
<MultiSlider>
    ...
    <SliderItem>
        ...
        <p>You never know how materials might be used! Sailors in the 1800s collected temperature data that still remains an important part of our ocean climate record today. (NPR, 2009)</p>
    </SliderItem>
</MultiSlider>
...
<SingleFigure size='large' src="./images/clone/Module_3/image9.png" caption='Image Credit: A cartoon describing FAIR data sharing by Patrick Hochstenbach, is licensed under CC0 1.0'/>
...
<LearnButton href="https://www.go-fair.org/" text="Click to Learn (external link)"/>
...
<CustomTabs>
    <Tab eventKey="one" title="FINDABLE">
      ...
      <ul>
        ...
        <li>
          Add rich, self-describing metadata in your data files and register the metadata in a metadata catalog, enabling your data to be properly curated.
          <ul>
...
<MultiSlider>
  <SliderItem type="multi">
    <h3>What?</h3>
    <p>Data types, volume, formats, and (where relevant) standards.</p>
  </SliderItem>
  <SliderItem type="multi">
    <h3>When?</h3>
    <p>The schedule for data archiving and sharing.</p>
  </SliderItem>
  <SliderItem type="multi">
    <h3>Where?</h3>
  ...
  <SliderItem type="multi">
    <h3>How?</h3>
    <p>How the plan enables long-term preservation of the data.</p>
  </SliderItem>
  <SliderItem type="multi">
    <h3>Who?</h3>
...
- [NOAA](https://oceanexplorer.noaa.gov/about/funding-opps/media/fy23-data-management-plan.pdf) (external link)
...
<SingleFigure size='full' src="./images/clone/Module_3/image10.jpeg" caption={<span>Credit: NASA <br/>Open Science Workflow Products Source: Opensciency.</span>}/>
...
<SingleFigure size='medium' src="./images/clone/Module_3/image11.png" caption="Credit: NASA"/>
...
<SimpleQuiz id="quiz-m3-l1-knowledge-check">
  <SingleChoice question='Open data can be freely used, reused, and redistributed by anyone - subject, at most, to the requirement to attribute and share alike.' answer='answer-1' isBool="true">
    <SingleAnswer text='True' id='answer-1' explanation='True is correct. The term open data is defined in the Open Data Handbook from the Open Knowledge Foundation: "Open data is data that can be freely used, re-used and redistributed by anyone - subject only, at most, to the requirement to attribute and share alike."'/>
    <SingleAnswer text='False' id='answer-2' explanation='False is incorrect. The term open data is defined in the Open Data Handbook from the Open Knowledge Foundation: "Open data is data that can be freely used, re-used and redistributed by anyone - subject only, at most, to the requirement to attribute and share alike."'/>
  </SingleChoice>
  <SingleChoice question='Finish the sentence. Making data open helps YOU because:' answer='answer-4'>
    <SingleAnswer text='A. Your data can be cited and you will get credit' id='answer-1' explanation={
        <>
          <span>A. Benefits of opening data for you as an individual include:</span>
          <ul>
            <li>Your data can be cited and you will get credit.</li>
            <li>You won't lose access to your data, even if you move institutions.</li>
            <li>Your publications are more likely to get cited when you link to open data.</li>
          </ul>
        </>
      }
    />
    <SingleAnswer text="B. You won't lose access to your data, even if you move institutions" id='answer-2' explanation={
        <>
          <span>B. Benefits of opening data for you as an individual include:</span>
          <ul>
            <li>Your data can be cited and you will get credit.</li>
            <li>You won't lose access to your data, even if you move institutions.</li>
            <li>Your publications are more likely to get cited when you link to open data.</li>
    ...
    />
    <SingleAnswer text='C. Your publications are more likely to get cited when you link to open data' id='answer-3' explanation={
        <>
          <span>C. Benefits of opening data for you as an individual include:</span>
          <ul>
            <li>Your data can be cited and you will get credit.</li>
            <li>You won't lose access to your data, even if you move institutions.</li>
            <li>Your publications are more likely to get cited when you link to open data.</li>
    ...
    <SingleAnswer text='D. All of the above' id='answer-4' explanation={
      <>
        <span>D. Benefits of opening data for you as an individual include:</span>
        <ul>
          <li>Your data can be cited and you will get credit.</li>
          <li>You won't lose access to your data, even if you move institutions.</li>
          <li>Your publications are more likely to get cited when you link to open data.</li>
  ...
  <MultipleChoice question='Which of the following can help make your data FAIR?' uniExplanations={true} correctExplanation='You can help make your data FAIR by getting a license and obtaining a Persistent IDentifier (PID).' incorrectExplanation='You can help make your data FAIR by getting a license and obtaining a Persistent IDentifier (PID).'>
    <MultipleAnswer text='Make your metadata accessible only as long as your data is available' id='answer-1' isAnswer='false'/>
    <MultipleAnswer text='Get a license for your data' id='answer-2' isAnswer='true'/>
...
- Chan, L., Okune, A., Hillyer, R., Albornoz, D., and Posada, A. (2019). _Contextualizing openness: Situating open science_. The University of Ottawa Press.
- Clyde, D. Spaceflight causes mitochondrial stress. _Nat Rev Genet_ **22**, 69 (2021). [https://doi.org/10.1038/s41576-020-00322-8](https://doi.org/10.1038/s41576-020-00322-8) (external link)
...
- Guillemin, T.A., Pepperell, J.G., Schilling, H.T. _et al_. 90 years of catch data reveal changes in catch composition in the Australian east coast recreational marlin fishery. _Rev Fish Biol Fisheries_ **35**, 371-389 (2025). [https://doi.org/10.1007/s11160-024-09906-7](https://doi.org/10.1007/s11160-024-09906-7) (external link)
...
- Maxmen, Amy. (2019, July 24). Science under fire: Ebola researchers fight to test drugs and vaccines in a war zone. _Nature, 572_, 16-17. doi: [https://doi.org/10.1038/d41586-019-02258-4](https://doi.org/10.1038/d41586-019-02258-4) (external link)
- NPR. (2009). _1800s-Era Sea Logs Chart Course Of Climate Change_. [https://www.npr.org/2009/10/18/113916471/1800s-era-sea-logs-chart-course-of-climate-change](https://www.npr.org/2009/10/18/113916471/1800s-era-sea-logs-chart-course-of-climate-change) (external link)
