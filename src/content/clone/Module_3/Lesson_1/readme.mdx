...
<QuoteImage quote="Open data are data that can be freely used, reused and redistributed by anyone - subject only, at most, to the requirement to attribute and share alike." byWho="Open Data Handbook from the Open Knowledge Foundation" bgImage="./images/clone/Module_3/opendatahandbookquote.jpg" />
...
<Definitions>
  ...
  <Definition title='Citizen Science'>
    **Example: Water Quality Testing in Beirut**
    ...
    For example, volunteer citizen scientists in Beirut were recruited from 50 villages to help test water quality [cite: chapter 5 of [Contextualizing Openness: Situating Open Science](https://idrc-crdi.ca/en/book/contextualizing-openness-situating-open-science)]. These volunteers were trained to be able to conduct the tests and in turn, not only was the data collected to inform the scientific advancements, the citizen scientists had the opportunity to learn to better manage their water resources and were able to improve conditions, creating a mutually beneficial interaction.
  </Definition>
  <Definition title='Open Data and Equitable Sharing of Knowledge'>
...
<SingleFigure size='large' src="./images/clone/Module_3/image6.jpeg" caption="Image source: CC-by openaire" link="https://www.openaire.eu/blogs/open-research-data-the-fairest-data-is-the-future-of-science-estonia-national-openaire-event-1"/>
...
<MultiSlider>
  ...
  <SliderItem>
    ...
    **My data will be used but not cited**
  ...
  <SliderItem>
    ...
    **Data are too sensitive to share**
  ...
  <SliderItem>
    ...
    **My data won't be useful to anyone else**

    You never know how materials might be used! [Sailors in the 1800s collected temperature data](https://www.npr.org/templates/story/story.php?storyId=113916471) that is an important part of our ocean climate record today!
  </SliderItem>
</MultiSlider>
...
<SingleFigure size='full' src="./images/clone/Module_3/image9.png" caption="Image by Patrick Hochstenbach, CC0 1.0; image illustrates each FAIR principle"/>
...
<SimpleQuiz>
  <SingleChoice question='Open data can be freely used, re-used and redistributed by anyone - subject, at most, to the requirement to attribute and share alike.' answer='answer-1' isBool="true">
    <SingleAnswer text='True' id='answer-1'/>
    <SingleAnswer text='False' id='answer-2'/>
  </SingleChoice>
  <SingleChoice question='Finish the sentence: Making data open helps YOU because _____.' answer='answer-4'>
