...
<Definitions>
    <Definition title='Example: NASA FAR Supplement 1852.227'>
        <p><a href="https://prod.nais.nasa.gov/far/far0595-nfs012617/5227.htm">NASA FAR Supplement 1852.227</a> outlines patent and data rights for government contracts.</p>
    </Definition>
</Definitions>
...
<SimpleQuiz id="quiz-m3-l4-knowledge-check">
  <SingleChoice question='Data cannot be shared if it is:' answer='answer-4'>
    <SingleAnswer text='A. ITAR controlled' id='answer-1' explanation='A. Data cannot be shared if it is: ITAR controlled, controlled unclassified information, and subject to intellectual property, copyright, and licensing concerns.'/>
    <SingleAnswer text='B. Controlled Unclassified Information' id='answer-2' explanation='B. Data cannot be shared if it is: ITAR controlled, controlled unclassified information, and subject to intellectual property, copyright, and licensing concerns.'/>
    <SingleAnswer text='C. Subject to intellectual property, copyright, and licensing concerns' id='answer-3' explanation='C. Data cannot be shared if it is: ITAR controlled, controlled unclassified information, and subject to intellectual property, copyright, and licensing concerns.'/>
    <SingleAnswer text='D. All of the above' id='answer-4' explanation='D. Data cannot be shared if it is: ITAR controlled, controlled unclassified information, and subject to intellectual property, copyright, and licensing concerns.'/>
  </SingleChoice>
  <SingleChoice question='It is best practice to start working with a repository _____.' answer='answer-3'>
    <SingleAnswer text='A. When you have test data ready' id='answer-1' explanation='A. Repository requirements can vary widely. You should start working with a repository as early as possible.'/>
    <SingleAnswer text='B. After you obtain a DOI' id='answer-2' explanation='B. Repository requirements can vary widely. You should start working with a repository as early as possible.'/>
    <SingleAnswer text='C. As early as possible' id='answer-3' explanation='C. Repository requirements can vary widely. You should start working with a repository as early as possible.'/>
    <SingleAnswer text='D. When you are ready to release your data' id='answer-4' explanation='D. Repository requirements can vary widely. You should start working with a repository as early as possible.'/>
  </SingleChoice>
  <SingleChoice question='Which one of the following might be able to help you get a DOI for your data:' answer='answer-4'>
    <SingleAnswer text='A. The repository you are working with' id='answer-1' explanation='Individuals can go through an authorized organization to get help obtaining a DOI, such as: the repository you are working with, your home organization, and a journal you are submitting a manuscript and data to.'/>
    <SingleAnswer text='B. Your home organization' id='answer-2' explanation='Individuals can go through an authorized organization to get help obtaining a DOI, such as: the repository you are working with, your home organization, and a journal you are submitting a manuscript and data to.'/>
    <SingleAnswer text='C. A journal you are submitting a manuscript and data to' id='answer-3' explanation='Individuals can go through an authorized organization to get help obtaining a DOI, such as: the repository you are working with, your home organization, and a journal you are submitting a manuscript and data to.'/>
    <SingleAnswer text='D. All of the above' id='answer-4' explanation='Individuals can go through an authorized organization to get help obtaining a DOI, such as: the repository you are working with, your home organization, and a journal you are submitting a manuscript and data to.'/>
  </SingleChoice>
  <MultipleChoice question='Which of the following are roles to consider when sharing data?' uniExplanations={true} correctExplanation='Possible roles to consider when sharing data include: developing guidance on privacy and cultural sensitivity of the data, developing the data documentation and metadata, and verifying the integrity of the data, metadata, and documentation transfer.' incorrectExplanation='Possible roles to consider when sharing data include: developing guidance on privacy and cultural sensitivity of the data, developing the data documentation and metadata, and verifying the integrity of the data, metadata, and documentation transfer.'>
    <MultipleAnswer text='Develop guidance on privacy and sensitivity of the data' id='answer-1' isAnswer='true'/>
