...
<SingleFigure size='small' src="./images/clone/Module_4/image540.png" />
...
<SingleFigure size='medium' src="./images/clone/Module_4/image197.png" />
...
<SingleFigure size='small' src="./images/clone/Module_4/image332.png" />
...
<SingleFigure size='small' src="./images/clone/Module_4/image425.png" />
...
<SingleFigure size='small' src="./images/clone/Module_4/image78.jpg" />
...
1. Navigate to the [Zenodo GitHub page](https://sandbox.zenodo.org/account/settings/github/). Click on the button 'Connect' to allow Zenodo to access your GitHub repositories.<br></br><SingleFigure size='large' src="./images/clone/Module_4/zenododoi1.jpg" />
2. Review the information about access permissions, then click 'Authorize Zenodo'.
3. Sync your GitHub with Zenodo by clicking 'Sync now' in the upper right corner. <br></br> <SingleFigure size='large' src="./images/clone/Module_4/zenododoi3.jpg" />
...
<SingleFigure size='medium' src="./images/clone/Module_4/image419.png"/>
...
<SimpleQuiz id="quiz-m4-l4-knowledge-check">
  ...
  <MultipleChoice question='Which of the following are roles that you should plan for when writing a SMP?'>
