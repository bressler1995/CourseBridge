...
<SimpleSlider>
  <SliderItem>
    ...
    <SingleFigure size='full' src="./images/clone/Module_4/image394.jpg"/>
  ...
  <SliderItem>
    <SingleFigure size='full' src="./images/clone/Module_4/image553.png"/>
  ...
  <SliderItem>
    <SingleFigure size='full' src="./images/clone/Module_4/image408.jpg"/>
  ...
  <SliderItem>
    ...
    <SingleFigure size='full' src="./images/clone/Module_4/image168.jpg"/>
...
<SingleFigure size='large' src="./images/clone/Module_4/image247.jpg" caption="Code example from https://github.com/UCB-stat-159-s23/site/blob/main/lectures/climate-data.ipynb" link="https://github.com/UCB-stat-159-s23/site/blob/main/lectures/climate-data.ipynb"/>

### What is Code vs Software?

<SingleFigure size='small' src="./images/clone/Module_4/image109.png"/>
...
<SingleFigure size='medium' src="./images/clone/Module_4/image530.png"/>
...
<SimpleQuiz>
  <MultipleMatch question='Determine whether a statement is a benefit or challenge by dragging each to the correct box.'>
    ...
    <MultipleMatchable id="draggable_4" type="draggable" text="Open Software developers can gain visibility & sustainability of their software."/>
    <MultipleMatchable id="draggable_5" type="draggable" text="Requires extra time for activities like documenting, publishing, & maintenance."/>
...
<SingleFigure size='large' src="./images/clone/Module_4/image110.jpg"/>
...
<SingleFigure size='large' src="./images/clone/Module_4/image290.png"/>
...
<SimpleQuiz>
  <SingleChoice question="Software is referred to as open source when it is publicly accessible; anyone can see, modify, and distribute the code as they see fit within the constraints set by the software license." answer='answer-1' isBool="true">
