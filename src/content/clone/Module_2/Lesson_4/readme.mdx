...
<SingleFigure size='full' src="./images/clone/Module_2/image36.jpeg" caption="Source: https://en.wikipedia.org/wiki/File:RStudio_IDE_screenshot.png" link="https://en.wikipedia.org/wiki/File:RStudio_IDE_screenshot.png"/>
...
<SingleFigure size='large' src="./images/clone/Module_2/calculatingenso.jpg"/>

3.  After the Notebook loads, you should see something like the following. Note – this actually uses the JupyterLab view!

<SingleFigure size='large' src="./images/clone/Module_2/calculatingenso2.jpg"/>
...
<SingleFigure size='large' src="./images/clone/Module_2/calculatingenso3.jpg"/>
...
<SimpleSlider>
  <SliderItem>
    <SingleFigure size='full' src="./images/clone/Module_2/calculatingenso4.jpg"/>
  </SliderItem>
  <SliderItem>
    <SingleFigure size='full' src="./images/clone/Module_2/image44.jpeg"/>
  </SliderItem>
</SimpleSlider>
