...
<DoubleFigure>
  <SingleFigure src='./images/clone/Module_1/image352.png'/>
  <SingleFigure src='./images/clone/Module_1/image347.png'/>
</DoubleFigure>
...
<SingleFigure size='large' src="./images/clone/Module_1/image106.jpg"/>
...
<QuoteImage quote="By applying a license to your work, you make clear what others can do with the things you're sharing, and also establish the conditions under which you're providing them (such as cite you)." byWho="Open Science Knowledge Base" bgImage="./images/clone/Module_1/knowledgebasequote.jpg" />

---

<img src="" style={{width: 350, height: 'auto'}} />
...
<CustomTabs>
    ...
    <Tab eventKey="three" title="GUID Elements For Selecting Between Options">
      <ul>
...
<SimpleQuiz>
  ...
  <SingleChoice question='Which of the following should be considered when sharing information?' answer='answer-4'>
    ...
    <SingleAnswer text='How are affected communities impacted by the release of the information?' id='answer-3'/>
