...
import MatchDraggable from '../../../../components/Simple/Match/MatchDraggable.jsx';
import MatchDroppable from '../../../../components/Simple/Match/MatchDroppable.jsx';
...
<Match>
  <MatchDraggable id='activitity_1_2_draggable_1' title='Fosters inclusivity, diversity, equity and accessibility'/>
  <MatchDraggable id='activitity_1_2_draggable_2' title='Engage with interested communities to increase representation throughout research efforts'/>
  <MatchDroppable id='activitity_1_2_droppable_1' title='Respecting cultural diversity'/>
  <MatchDroppable id='activitity_1_2_droppable_2' title='IDEA'/>
</Match>

<table>
  <tr>
    <td>Engage with interested communities to increase representation through research efforts</td>
  ...
  <tbody>
    <tr>
        <td colSpan={2}>
            ...
            <p><img src="./images/clone/Module_1/image243.jpg" style={{width: '100%', height: 'auto'}} />
</p>
        </td>
    </tr>
  </tbody>
